"""
This module provides useful classes for all AixCaliBuHa.
"""

import ebcpy.data_types as ebcpy_data_types
...
class CalibrationClass:
    ...
    def set_goals(self, goals):
        ...
        :param Goals goals:
            Goals-data-type
        """
        if not isinstance(goals, ebcpy_data_types.Goals):
    ...
    def set_tuner_paras(self, tuner_paras):
        ...
        """
        if not isinstance(tuner_paras, ebcpy_data_types.TunerParas):

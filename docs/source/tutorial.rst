...
.. automodule:: aixcal.examples.data_types_example
    :members:
...
For example the function :meth:`~aixcal.preprocessing.conversion.convert_hdf_to_mat`
is used in the class :meth:`~aixcal.data_types.MeasInputData` as mat-files are needed for

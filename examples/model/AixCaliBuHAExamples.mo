...
<p>
  ...
  model HeatPumpSystemWithTimTab "Example for a heat pump system"
    package Medium_sin = AixLib.Media.Water;
    package Medium_sou = AixLib.Media.Water;
    AixLib.Fluid.MixingVolumes.MixingVolume vol(
      energyDynamics=Modelica.Fluid.Types.Dynamics.FixedInitial,
  ...
  equation
    ...
    connect(realExpression.y, Pel)
      annotation (Line(points={{104.2,112},{130,112}}, color={0,0,127}));
    connect(InputTDryBul.y[1], TOut.T) annotation (Line(points={{-83,10},{-66,
            10},{-66,64},{-4,64}}, color={0,0,127}));
    connect(InputTDryBul.y[1], heatPumpSystem.T_oda) annotation (Line(points={{
            -83,10},{-66,10},{-66,-46},{-30,-46},{-30,-45.0714},{5.95,-45.0714}},
          color={0,0,127}));
    annotation (Diagram(coordinateSystem(preserveAspectRatio=false, extent={{-120,
              -120},{120,120}})),
      experiment(Tolerance=1e-6, StopTime=86400),
